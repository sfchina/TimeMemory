...
/**
 * @params.dir capture file to the folder
 * @next call back function
 */
var captureImage=function(params,next){
	var curDateTime=new Date();
	console.info('captureImage'+curDateTime);
	var targetFolder=path.join(global.conf.baseDir,params.dir);
	...
	var child = exec(cmd, function (error, stdout, stderr) {
		...
		var result={'rc':consts.status.rc_ok,'rm':null,'data':{}};
		if(error){
